...
#include "ir/e2sm_dapp_ev_trg_frmt_0.h"

//////////////////////////////////////
// RIC Action Definition
/////////////////////////////////////

#include "ir/e2sm_dapp_act_def_frmt_0.h"

/////////////////////////////////////
// RIC Indication Header
/////////////////////////////////////

#include "ir/e2sm_dapp_ind_hdr_frmt_0.h"

/////////////////////////////////////
// RIC Indication Message
/////////////////////////////////////

#include "ir/e2sm_dapp_ind_msg_frmt_0.h"

/////////////////////////////////////
// RIC Control Header
/////////////////////////////////////

#include "ir/e2sm_dapp_ctrl_hdr_frmt_0.h"

/////////////////////////////////////
// RIC Control Message
/////////////////////////////////////

#include "ir/e2sm_dapp_ctrl_msg_frmt_0.h"

/////////////////////////////////////
// RIC Control Outcome
/////////////////////////////////////

#include "ir/e2sm_dapp_ctrl_out_frmt_0.h"
...
typedef enum {
  FORMAT_0_E2SM_DAPP_EV_TRIGGER_FORMAT,
...
typedef struct {
  ...
  union {
    e2sm_dapp_ev_trg_frmt_0_t frmt_0;
  };
...
typedef enum { FORMAT_0_E2SM_DAPP_ACT_DEF, END_E2SM_DAPP_ACT_DEF } e2sm_dapp_act_def_format_e;

typedef struct {
  uint32_t ric_style_type;
  e2sm_dapp_act_def_format_e format;

  union {
    e2sm_dapp_act_def_frmt_0_t frmt_0;
  };
...
typedef struct {
  ...
  union {
    e2sm_dapp_ind_hdr_frmt_0_t frmt_0;
  };
} e2sm_dapp_ind_hdr_t;
...
typedef struct {
  ...
  union {
    e2sm_dapp_ind_msg_frmt_0_t frmt_0;
  };
...
typedef struct {
  ...
  union {
    e2sm_dapp_ctrl_hdr_frmt_0_t frmt_0;
  };
...
typedef struct {
  ...
  union {
    e2sm_dapp_ctrl_msg_frmt_0_t frmt_0;
  };
...
typedef struct {
  ...
  union {
    e2sm_dapp_ctrl_out_frmt_0_t frmt_0;
  };
